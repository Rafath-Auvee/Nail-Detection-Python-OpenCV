...
foreground2 = np.ones((300, 300, 3), dtype='uint8') * 255
# Open the camera
...
while True:
    ...
    added_image2 = cv2.addWeighted(background[150:250,150:250,:],alpha,foreground2[0:200,0:200,:], 1.3 - alpha, 0)
    # Change the region with the result
    background[150:250, 150:250] = added_image
    background[150:250, 150:250] = added_image2
